...
## Current strategy: multi-leg congestion recovery-hold experiment
...
the direct service is estimated to recover and deliver sooner than the safe
detour, and either the detour needs at least two changes between services or it
needs exactly one change while the direct booking spans multiple physical legs
and every matching active constraint is a congested-leg constraint. Simple
single-leg transfers, closed-berth constraints, and mixed constraints delegate.
