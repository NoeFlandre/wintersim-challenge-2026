...
## Current strategy: pure-leg low-margin recovery-hold experiment
...
recover and deliver sooner than that detour. For a pure leg constraint, the
strategy delegates instead when the positive recovery-versus-detour margin is
smaller than the first safe route's derived departure headway. Mixed
leg-and-port constraints retain the v3 hold.
