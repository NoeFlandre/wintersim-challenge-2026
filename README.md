...
- **Round 1:** the organizer archive is privately bootstrapped at
  `.challenge/round1/source/`, and six controlled strategy experiments have
  completed. All six were rejected: three were worse and three tied the
  ...
  [`Round 1 phase-aware booking report`](docs/experiments/round1-phase-aware-valid-route-booking-v1.md).
...
Round 1's latest phase-aware valid-route booking experiment produced a
`24.21744876585007` loss, worse than fallback, and was rejected under the
strict improvement rule; its candidate evidence remains preserved in the
