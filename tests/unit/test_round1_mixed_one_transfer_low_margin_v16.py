"""RED contract for the Round 1 v16 low-margin mixed-transfer guard."""
...
def test_mixed_one_transfer_below_half_headway_is_held() -> None:
    context, now, shipment = _fixture(safe_distance=100.0)

    # RED: v3 delegates this one-transfer mixed case; v16 must return False.
...
def test_mixed_one_transfer_above_half_headway_delegates() -> None:
